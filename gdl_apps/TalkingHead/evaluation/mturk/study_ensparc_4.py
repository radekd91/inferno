...
def design_study_4(model, num_rows, num_videos_per_row, output_folder, num_catch_trials=0, num_repeats=5, videos=None, videos_b=None):
    ...
    catch_videos, catch_answers, catch_path = load_catch_videos_study_4()
    ...
    for ri in range(num_rows):
        ...
        while video_count < num_videos_per_row:
            ...
            shutil.copy(video, video_output)
            ...
            hit_list_line_dbg += [f"{video_relative_to_output_dbg}"]
            hit_list_line_mturk += [f"{video_mturk}"]
