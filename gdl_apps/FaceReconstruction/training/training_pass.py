...
#                 cfg_detail=None, 
#                 # test_first=True, 
#                 start_i=-1, resume_from_previous = True, force_new_location = False,
#                 project_name_=None):
#     project_name_ = project_name_ or project_name
...
#     dm, data_name = prepare_data(configs[0])
#     dm.setup()
...
#         experiment_name = create_experiment_name(cfg_coarse, cfg_detail, data_name)
...
#         model = single_stage_training_pass(model, cfg, stages[i], stages_prefixes[i], dm, wandb_logger,
...
def configure_and_train(coarse_cfg_default, coarse_overrides, detail_cfg_default, detail_overrides):
