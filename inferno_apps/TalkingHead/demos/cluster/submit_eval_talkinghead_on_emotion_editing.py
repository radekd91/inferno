...
import inferno_apps.TalkingHead.evaluation.eval_talking_head_on_audio_condition_interp as script
import datetime
...
def submit(resume_folder,
    ...
    cpus = 3 #cfg.data.num_workers + 2 # 1 for the training script, 1 for wandb or other loggers (and other stuff), the rest of data loading
