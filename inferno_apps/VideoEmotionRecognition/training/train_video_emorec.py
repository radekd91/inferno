...
from inferno_apps.VideoEmotionRecognition.training.training_pass import( single_stage_training_pass, 
...
from inferno.models.video_emorec.VideoEmotionClassifier import VideoEmotionClassifier, MostFrequentEmotionClassifier
