...
class CelebVTextDataModule(FaceVideoDataModule): 
...
# class CelebVTextDataset(VideoDatasetBase):
class CelebVTextDataset(VideoDatasetBaseV2):
...
def main(): 
    ...
    root_dir = Path("/ps/project/EmotionalFacialAnimation/data/celebvtext/CelebV-Text/downloaded_celebvtext/processed_25fps")
    output_dir = Path("/is/cluster/fast/rdanecek/data/celebvtext/")

    # processed_subfolder = "processed"
    processed_subfolder = "processed_test"
