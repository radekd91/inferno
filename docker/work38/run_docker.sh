...
then
    ...
    docker run -it --gpus all -v $PWD/..:/workspace/repos/inferno inferno_docker:test /bin/bash
    ...
    docker run -it --gpus all -v $PWD/..:/workspace/repos/inferno inferno_docker:test $@
